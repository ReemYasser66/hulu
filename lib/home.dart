        ...
        children: [
          Column(
            children: [
              Container(
                ...
                child: Column(
                  children: [
                   ...
                   Padding(
                     ...
                     child: Row(mainAxisAlignment: MainAxisAlignment.end,
                       children: [
                         InkWell(onTap:(){
                           Navigator.push(context, MaterialPageRoute(builder: (context){return Sittings();}));
                         } ,
                  ...
                  const SizedBox(height: 350,),
                    ...
                    child: InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context){return const VideoApp();}));
                      },
                    ...
                    Row(
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context){return Download();}));
                          },
                          child: Container(
                            height: 45,
                            width: 45,
              ...
              //         height: 170,
              //         width: 170,
              //         decoration: BoxDecoration(image: DecorationImage(image: AssetImage('images/Movie (1).png'))),
              //       ),
              //       Container(
              //         margin: EdgeInsets.all(10),
              //         height: 170,
              //         width: 170,
              //         decoration: BoxDecoration(image: DecorationImage(image: AssetImage('images/Movie.png'))),
              //       ),
              //       Container(
              //         margin: EdgeInsets.all(10),
              //         height: 170,
